...
<html lang="en">
    ...
    <body>
       ...
       <center><h5>Lecture Theatre ground_floor</h5></center><br>
        <div class="row">
            <?php
        ...
        <center><h5>Lecture Theatre first_floor</h5></center><br>
        <div class="row">
            <?php
                $connection = mysqli_connect("localhost","root","");
                $db = mysqli_select_db($connection,"my_hotel");
        ...
        <center><h5>Lecture Theatre second_floor</h5></center><br>
        <div class="row">
            <?php
                $connection = mysqli_connect("localhost","root","");
                $db = mysqli_select_db($connection,"my_hotel");
        ...
        <center><h5>Lecture Theatre third_floor</h5></center><br>
        <div class="row">
            <?php
                $connection = mysqli_connect("localhost","root","");
                $db = mysqli_select_db($connection,"my_hotel");
